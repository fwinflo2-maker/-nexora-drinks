...
test('team member roles cannot be updated by members without permission', function () {
    $owner = User::factory()->create();
...
test('team members cannot be removed by members without permission', function () {
    $owner = User::factory()->create();
    $regularMember = User::factory()->create();
    $member = User::factory()->create();
    $team = Team::factory()->create();
