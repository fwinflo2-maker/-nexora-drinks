...
<body>
@include('fnb.pdf._header', ['team' => $team, 'docType' => 'Performance du menu'])
<div class="doc-title">Ventes par article</div>
...
<table>
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right">{{ number_format(array_sum(array_column($rows, 'total_revenue')), 0, ',', ' ') }}</td>
        </tr>
    </tfoot>
</table>
