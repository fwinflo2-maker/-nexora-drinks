...
export default function CategoryForm({ _action, category }: { _action: string, category?: any }) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        if (_action === 'edit' && item?.id) {
            put(route('drinks.categories.update', { current_team: team.slug, category: item.id }));
        } else {
            post(route('drinks.categories.store', { current_team: team.slug }));
        }
    };
