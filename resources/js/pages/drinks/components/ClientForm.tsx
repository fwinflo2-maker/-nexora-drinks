...
export default function ClientForm({ _action, client }: { _action: string, client?: any }) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        if (_action === 'edit' && item?.id) {
            put(route('drinks.clients.update', { current_team: team.slug, client: item.id }));
        } else {
            post(route('drinks.clients.store', { current_team: team.slug }));
        }
    };
