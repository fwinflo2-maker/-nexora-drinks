                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Un code PIN sécurisé vous sera demandé lors
                                de la connexion. Récupérez-le depuis votre
                                application TOTP sur votre téléphone.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                un code PIN sécurisé vous sera demandé lors de
                                la connexion. Récupérez-le depuis une application
