...
<title>Parametres pour etat des charges</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Etat_Charge.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Calcul du Chiffre d'affaire</legend>
<table >
<tr>
