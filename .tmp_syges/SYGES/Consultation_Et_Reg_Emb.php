...
<title>Consultation de la liste des régularisations du stock des emballages</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="8"><h3>Etat des régularisations du stock des emballages  </h3></td>
          </tr>
          <tr align="center" bgcolor="#CCCCCC">
            ...
            <tr bgcolor="#CCCCCC">
                ...
                <td align="center"><h5> Stock Total Avant</h5> </td>
                <td align="center" ><h5>Nouveau Stock Total  </h5> </td>
                <td align="center" ><h5>Stock Dispo. Avant </h5> </td>
                <td  align="center"><h5>Nouveau Stock Dispo. </h5></td>
	       ...
	       //
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="left"> <?php echo $rslt['ID_EMBALLAGE'].'/'.$libelle; ?> </td>
                        <td  align="center"> <?php echo $rslt['STOCKTTAV']; ?> </td>
                        <td  align="center"> <?php echo $rslt['STOCKTTAP']; ?> </td>
                        <td  align="center"> <?php echo $rslt['QTESTOCKAV']; ?> </td>
                        <td  align="center"> <?php echo $rslt['QTESTOCKAP']; ?> </td>
...
?>
<tr>
	<td><a href="Etat_Reg_Emb.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Statut=<?php echo $_GET['Stat'];?>"/><input type="button" value="Imprimer" /></td></a>
