...
<title>Formulaire  de suppression d'un Appro. Cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_ApproCession.php" method="post">

<fieldset style=" width:1050px;"><legend>Informations sur l'appro cession à supprimer</legend>
<table >
<tr>
