        ...
        function go()
		{
			...
			xhr.onreadystatechange = function()
			{
				...
				if(xhr.readyState == 4 && xhr.status == 200)
				{
					...
					document.getElementById('tfournisseur').innerHTML =leselect;
				}
			}
			// Ici on va voir comment faire du post
			xhr.open("POST","Ajax_Fournisseur_Appro.php",true);
...
<a href="index.php?formulaire=Enreg_Fournisseur_Appro"><input type="button" value="Nouveau Fournisseur" name="nouveaufssr" style="margin-left:650px; background:#F00;"/> </a>
          <table id='tfournisseur' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="8"><h5>Liste des fournisseurs pour Approvionnement</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_FOURNISSEUR, NOM, NUMTEL, EMAIL, STATUT FROM FOURNISSEUR WHERE STATUT="Actif" ORDER BY NOM ' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Enreg_Appro&Id=<?php echo $rslt['ID_FOURNISSEUR'];?> "/> <img src="IMG/Select.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
