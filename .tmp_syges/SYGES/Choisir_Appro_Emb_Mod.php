	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Mod_Appro_Emb.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="6"><h5>Liste des Appro. Emballage pour Modification</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
$i = 0;	
$sql='SELECT  ID_APPRO, DATE_APPRO, LOGIN, OBSERVATION FROM APPROEMB WHERE STATUT="N" ORDER BY DATE_APPRO DESC LIMIT 0,20 ' ;
		...
		//
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Modification_Appro_Emb&Ap=<?php echo $rslt['ID_APPRO'];?>"/> <img src="IMG/b_edit.png"/> </a></td>
                        <td  align="center"> <a href="index.php?formulaire=Validation_Appro_Emb&Ap=<?php echo $rslt['ID_APPRO'];?>"/> <img src="IMG/Liste.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
