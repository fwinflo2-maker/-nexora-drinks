...
<title>Choisir une Ventepour Consigne.</title>
	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Cons_Vente.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="6"><h5>Liste des ventes pour consigner/deconsigner</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  ST.ID_SORTIESTOCK, ST.DATESORTIESTOCK, ST.ID_CLIENT,C.ID_CLIENT, C.NOM, ST.OBSERVATION FROM SORTIE_STOCK ST, CLIENT C WHERE  ST.ID_CLIENT=C.ID_CLIENT AND  ST.STATUT="V" ORDER BY ST.DATESORTIESTOCK DESC LIMIT 0,20 ' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Enreg_Consigne&Vte=<?php echo $rslt['ID_SORTIESTOCK'];?> &Clt=<?php echo $rslt['ID_CLIENT'];?> "/> <img src="IMG/Select.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
