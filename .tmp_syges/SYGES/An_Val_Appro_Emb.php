...
<title>Formulaire  de d'ann d'un Appro. d'emb</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_An_Val_Appro_Emb.php" method="post">

<fieldset style=" width:1060px;"><legend>Informations sur l'approvisionnement à dévalider</legend>
<table >
<tr>
    ...
    <td><input type="text" id="observationappro" name="observationappro" maxlength="" style="width:230px; background-color:#ECECEC;" value="<?php echo $rslt2['OBSERVATION']; ?>" readonly="readonly"/></td>
</tr>
<tr>
    <td colspan="6" align="right"><input type="submit" align="left" value="Annuler La Validation" id="DeValider" name="DeValider" style="background:#F00"/></td>
</tr>
