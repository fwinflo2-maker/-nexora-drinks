...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Gerant" || $_SESSION['habilitation']=="Caissier"))
{
	...
	include("fonctions.php");
			...
			//ON RECUPERE 
		$sql = " select id_appro, id_emballage, montant, qte from rtrembfssr where id_rtremb='".$_GET['Id']."'";
...
<title>Formulaire  de suppression d'un emballage à un retour fournisseur</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Emb_Rtr.php" method="post">
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer un emballage à un retour fournisseur</legend>
<table>
<tr>
	<td><label for="codertr">Consigne *</label> </td>
    <td><input type="text" id="codertr" name="codertr" value="<?php echo $_GET['Id'];?>" readonly="readonly" style="background:#ECECEC; width:200px;"/></td>
