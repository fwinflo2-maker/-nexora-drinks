...
$couleur = "darkgray";
	...
	$sql='SELECT * FROM USER WHERE HABILITATION="Caissier" ORDER BY NOM' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Modification_Utilisateur_Gerant&Login=<?php echo $rslt['LOGIN'];?> "/> <img src="IMG/b_edit.png"/> </a></td>
                <?php
				$i++;
		 }
				?>
