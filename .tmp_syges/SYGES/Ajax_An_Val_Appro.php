...
$couleur = "darkgray";
$i = 0;
$sql='SELECT  ID_APPRO, DATE_APPRO, ID_FOURNISSEUR, OBSERVATION FROM APPROVISIONNEMENT WHERE ID_APPRO LIKE "%'.$_POST['libelle'].'%" AND STATUT="V" ORDER BY DATE_APPRO DESC ' ;
