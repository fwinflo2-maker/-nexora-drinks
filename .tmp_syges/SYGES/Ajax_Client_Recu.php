...
?>
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="8"><h5>Choisir un Client pour Impression d'un recu</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_CLIENT, NOM, NUMTEL, EMAIL, STATUT FROM CLIENT WHERE STATUT="Actif" AND NOM LIKE "%'.$_POST['nom'].'%" ORDER BY NOM ' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Choisir_Vente_Recu&Clt=<?php echo $rslt['ID_CLIENT'];?> "/> <img src="IMG/Select.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
