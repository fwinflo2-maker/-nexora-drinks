...
<title>Formulaire  de suppression des articles d'une sortie cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Article_SortieCession.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer un article à une sortie Cession</legend>
<table>
<tr>
...
<tr>
    ...
    <td><input type="text" id="qtesortie" name="qtesortie" style="background:#ECECEC; width:200px;" value="<?php echo $_GET['QTE']?>" readonly="readonly"/></td>
</tr>
<tr>
