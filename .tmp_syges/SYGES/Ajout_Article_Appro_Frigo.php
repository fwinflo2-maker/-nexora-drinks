...
<form action="CTRL/Controle_Ajout_Article_Frigo.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:1050px;"><legend>Ajouter des articles à un Appro du frigo</legend>
<table>
<tr>
...
<tr>
    ...
    <td><select name="codeart" id="codeart" style="width:300px;">
     <?php
	    $sql = " select id_article ,marque,libelle, qtestock from article  where statut='Actif' and id_article not in (select id_article from article_recu_frigo where id_appro ='".$_GET['AP']."') order by libelle  ";
