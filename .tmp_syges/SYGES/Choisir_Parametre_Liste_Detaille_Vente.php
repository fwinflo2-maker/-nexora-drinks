...
<body>
<form method="post" action="CTRL/Controle_Liste_Detaille_Vente.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'état detaille des Ventes</legend>
<table >
<tr>
