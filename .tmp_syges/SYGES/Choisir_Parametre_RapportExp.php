...
<body>
<form method="post" action="CTRL/Controle_RapportExp.php" onsubmit="return verif_form()">
<fieldset style="width:750px; margin-left:150px"><legend>Rapport d'Exploitation</legend>
<table >
	<tr>
