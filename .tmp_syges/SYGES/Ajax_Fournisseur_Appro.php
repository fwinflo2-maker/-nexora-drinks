...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_FOURNISSEUR, NOM, NUMTEL, EMAIL, STATUT FROM FOURNISSEUR WHERE NOM LIKE "%'.$_POST['nom'].'%" AND STATUT="Actif" ORDER BY NOM ' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Enreg_Appro&Id=<?php echo $rslt['ID_FOURNISSEUR'];?> "/> <img src="IMG/b_edit.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
