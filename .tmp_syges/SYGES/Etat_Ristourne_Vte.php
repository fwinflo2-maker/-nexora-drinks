...
$tauxpsaristournes=0;
 ...
 $pdf->Write(62,'                                                      AVOIR PARTICIPATION RISTOURNES (Sur Ventes)');
 $pdf->Ln(2);
...
$reponse2= $DataBase->query($sql2);
  while($rslt2= $reponse2->fetch())
  {
	...
	//calcul des valeurs totales
	  ...
	  $pdf->Cell(75,5,$libelle,1,0,'L');
	  $pdf->Cell(35,5,number_format($qte, 0, ',', ' '),1,0,'C');
...
//affichage les ristournes (pr tous les articles)
	  ...
	  $pdf->Cell(35,5,number_format($TTqte, 0, ',', ' '),1,0,'C');
	  $pdf->Cell(45,5,'//',1,0,'C');
...
$valeurepargneachat=$valeurhtPSA-$valeurristournestaux;
 ...
 $pdf->Cell(30,5,'TOTAL RISTOURNES',1,0,'C',1);
