	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_An_Val_Appro_Frigo.php",true);
...
$couleur = "darkgray";
$i = 0;			
$sql='SELECT  ID_APPRO, DATE_APPRO, LOGIN, OBSERVATION FROM APPROFRIGO WHERE STATUT="V" ORDER BY DATE_APPRO DESC LIMIT 0,20 ' ;
