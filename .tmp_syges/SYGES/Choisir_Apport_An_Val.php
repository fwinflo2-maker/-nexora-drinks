	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_An_Val_Apport.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des Mouvements de fonds pour dévalidation</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT * FROM APPORT WHERE STATUT="V" ORDER BY DATE_APPORT DESC LIMIT 0,30' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=An_Val_Apport&Id=<?php echo $rslt['ID_APPORT'];?> "/> <img src="IMG/Select.png"/> </a></td>
                <?php
				$i++;
		 }
				?>
