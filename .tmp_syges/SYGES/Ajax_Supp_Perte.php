...
$couleur = "darkgray";
			$i = 0;
			$cod = 'PER';
	$sql='SELECT  ID_SORTIESTOCK, DATESORTIESTOCK, LOGIN, OBSERVATION FROM SORTIE_STOCK_FRIGO WHERE STATUT="N" AND  ID_SORTIESTOCK LIKE "%'.$cod.'%" AND ID_SORTIESTOCK LIKE "%'.$_POST['codevte'].'%" ORDER BY DATESORTIESTOCK DESC ' ;
