...
<title>Formulaire  de validation d'un Appro. cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_val_ApproCession.php" method="post">
<fieldset style=" width:1060px;"><legend>Informations sur l'appro cession à valider</legend>
<table >
<tr>
