...
return result;
 ...
 function verif_form()
 {
 if(isNaN(document.getElementById('solde').value)||(document.getElementById('solde').value==""))
           {
            alert('Le Solde initial est un numérique.');
			document.getElementById('solde').focus();
			return false;
           }
