...
return result;
 ...
 function verif_form()
 {
  if(document.getElementById('codeart').value=="")
           {
            alert('BV choisir l\'article non definit.');
			document.getElementById('codeart').focus();
			return false;
           }
  if(document.getElementById('typemouv').value=="")
           {
            alert('BV Choisir le type d\'etat à afficher.');
			document.getElementById('typemouv').focus();
			return false;
           }
...
if ((document.getElementById('Instance').checked==false)&&(document.getElementById('Valide').checked==false))
	{
			alert('BV définir le Statut.');
