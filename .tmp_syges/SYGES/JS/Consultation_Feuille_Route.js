...
return result;
 ...
 function verif_form()
 {
  if(document.getElementById('mag').value=="")
           {
            alert('BV Choisir le Magasin.');
			document.getElementById('mag').focus();
			return false;
           }
  if(document.getElementById('codeuser').value=="")
           {
            alert('BV Choisir l\'utilisateur.');
			document.getElementById('codeuser').focus();
			return false;
           }
...
if ((document.getElementById('Instance').checked==false)&&(document.getElementById('Valide').checked==false))
	{
			alert('BV définir le Statut des ventes a afficher.');
