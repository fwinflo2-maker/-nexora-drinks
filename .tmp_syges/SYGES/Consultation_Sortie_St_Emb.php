...
<title>Consultation de l'etat des sorties de stock d'un emballage</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="4"><h3>Etat des sorties de stock  : <?php echo $libelle .' ('.$_GET['Emb'].')' ; ?></h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
...
<!--///////////////////////////////Deconsignation  Approvisionnements-->
		  <tr align="center">
          	<td colspan="4"><h4>Deconsignation Approvisionnements </h4></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$qte=0;
			...
			while($rslt1= $reponse1->fetch())
			{
				...
				if ($i%2 == 0)
					...
					?>
                    		<td  align="center"> <?php echo dateFormatFrancais($rslt1['DATE_RTREMB']); ?> </td>
...
<tr bgcolor="#CCCCCC">
	...
	<td align="center" colspan="2"><h4>Total Colis : <?php echo $qte; ?> </h4></td>
</tr>
<!--///////////////////////////////Consignes Ventes-->
		  <tr align="center">
          	<td colspan="4"><h4>Consignes Ventes</h4></td>
          </tr>
            <tr bgcolor="#CCCCCC">
                <td align="center" ><h5>Date </h5> </td>
...
$qte2=0;
			...
			if ($i%2 == 0)
				...
				echo "<tr bgcolor=$couleur>";
				?>
                		<td  align="center"> <?php echo dateFormatFrancais($rslt1['DATE_CONSIGNE']); ?> </td>
...
?>
<tr>
	<td align="center"><a href="Etat_Sortie_St_Emb.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Emb=<?php echo $_GET["Emb"];?>"/><input type="button" value="Imprimer" /></td></a>
	<td colspan="" align="center"><h4>Nombre d'emballage(s) : <?php echo $nbre; ?> </h4></td>
