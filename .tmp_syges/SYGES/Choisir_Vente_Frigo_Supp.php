	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Supp_Vente_Frigo.php",true);
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_SORTIESTOCK, DATESORTIESTOCK, LOGIN, OBSERVATION FROM SORTIE_STOCK_FRIGO WHERE STATUT="N" ORDER BY ID_SORTIESTOCK DESC LIMIT 0,20' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Suppression_Vente_Frigo&Vte=<?php echo $rslt['ID_SORTIESTOCK'];?>"/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
