...
<title>Formulaire  de suppression d'un Versement.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Vers.php" method="post">
<fieldset style=" width:1050px;"><legend>Informations sur le Versement à Supprimer</legend>
<table >
<tr>
...
<table>
<tr>
    <td align="center" > <input type="submit" name="Supprimer" id="Supprimer" value="Supprimer" style="margin-left:850px; background:#F00;"/></td>
</tr>
</table>
