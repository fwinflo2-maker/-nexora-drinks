...
<form action="CTRL/Ctrl_Mod_Emb_Vers.php" method="post" onSubmit="return verif_form()" >
...
<tr>
    ...
    <td><input type="text" id="qte" name="qte" style="width:200px;" value="<?php echo $_GET['QTE']; ?>"/></td>
</tr>
<tr>
</tr>
