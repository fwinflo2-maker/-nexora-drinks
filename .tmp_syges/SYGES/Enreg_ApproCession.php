...
<title>Formulaire  d'enregistrement d'un Appro Cession.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Controle_Appro_Cession.php" method="post" onsubmit="return verif_form()" >

<fieldset style=" width:1050px;"><legend>Informations sur l'appro cession</legend>
<table >
<tr>
	<td><label for="codeappro"> Code * </label></td>
    <td><input type="text" id="codeappro" name="codeappro" readonly="readonly" style="width:150px; background-color:#ECECEC" value="<?php echo generer_code_approcession();?>"/></td>
    <td><label for="date_appro"> Date de l'appro * </label> </td>
    <td><input type="text" id="date_appro" name="date_appro"style="width:120px;" value="<?php echo date("d/m/Y");?>"/> <input type="button" value="Calendrier" onclick="displayCalendar(document.forms[0].date_appro,'dd/mm/yyyy',this)" /></td>
	<td><label for="observationappro"> Observation  </label></td>
    <td><input type="text" id="observationappro" name="observationappro" maxlength="50" style="width:200px;"/></td>
</tr>
</table>
</fieldset>
<fieldset style=" width:1050px;"><legend>Informations sur les articles</legend>
<table>
<tr>
