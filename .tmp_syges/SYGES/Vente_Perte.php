...
<title>Formulaire  d'enregistrement d'une Perte.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Controle_Perte.php" method="post" onsubmit="return verif_form()" >

<fieldset style=" width:1050px;"><legend>Informations sur la Perte</legend>
<table >
<tr>
	<td><label for="codevente"> Code * </label></td>
    <td><input type="text" id="codevente" name="codevente" readonly="readonly" style="width:150px; background-color:#ECECEC" value="<?php echo generer_code_perte();?>"/></td>
    <td><label for="date_vente"> Date de la perte * </label> </td>
    <td><input type="text" id="date_vente" name="date_vente"style="width:150px;" value="<?php echo date("d/m/y");?>"/> <input type="button" value="Calendrier" onclick="displayCalendar(document.forms[0].date_vente,'dd/mm/yyyy',this)" /></td>
	<td><label for="observationsortie"> Observation  </label></td>
    <td><input type="text" id="observationsortie" name="observationsortie" maxlength="35" style="width:200px;"/></td>
</tr>
</table>
</fieldset>
