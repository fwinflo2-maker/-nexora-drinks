<?php
		...
		//on verifie le statut de la sortie si c non valide alors pas de mise à jr du stock des emballages
		...
		$sql="delete from emballagesortiecession where id_consigne='".$_POST["codeconsigne"]."'";
        $req = $DataBase->prepare($sql);
		$insere = $req->execute();	
		?>
				<script language="javascript" type="text/javascript">
				/*alert('Suppression effectue');*/
				window.location.replace("../index.php?formulaire=Modification_SortieCession&SC=<?php echo $_POST["codesortie"];?>");
				</script>
			<?php
			exit();
?>