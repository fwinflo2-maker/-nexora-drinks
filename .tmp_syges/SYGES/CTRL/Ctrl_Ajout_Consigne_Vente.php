	...
	if(isset($_POST['codevente'])&& (isset($_POST['Emb'])))
	{
			...
			else
			{
				...
				else
				{
					...
					//on reduit le stock de cet emballage
				$sql7= " select qtestock from emballage where id_emballage='".$_POST['Emb']."'";
				...
				while($rslt7= $reponse7->fetch())
				{
					...
					$insere4=0;
					$sql4="update emballage set qtestock=:qtestock where id_emballage='".$_POST['Emb']."'";
