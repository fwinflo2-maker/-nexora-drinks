<?php
	...
	if(isset($_POST['Code']))
	{
		...
		$trve= false;
		 $sql = " select id_apport from apport where id_apport='".$code."' ";
		...
		$insere=0;
		$sql="delete from apport  where id_apport='".$code."'";
		...
		?>
				...
				window.location.replace("../index.php?formulaire=Choisir_Apport_Supp");
				</script>
			<?php
			exit();
		}
