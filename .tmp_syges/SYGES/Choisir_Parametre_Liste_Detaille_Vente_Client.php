...
<title>Choisir parametre pour liste detaille des ventes</title>
<style type="text/css">
label
{
	display:block;
...
<script src="JS/Consultation_Vente_Client.js" type="text/javascript"></script>
<link type="text/css" rel="stylesheet" href="dhtmlgoodies_calendar/dhtmlgoodies_calendar.css?random=20051112" media="screen" />
	<script type="text/javascript" src="dhtmlgoodies_calendar/dhtmlgoodies_calendar.js?random=20060118"></script>
</head>

<body>
<form method="post" action="CTRL/Controle_Liste_Detaille_Vente_Client.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'état detaille des achats Clent(s)</legend>
<table >
<tr>
	<td align="left"><label for="codeclt"> Client :</label></td>
    <td><select name="codeclt" id="codeclt" style="width:200px;">
    <option> TOUS </option>
    <?php
    	$sql = " select id_client ,nom from client order by nom  ";
