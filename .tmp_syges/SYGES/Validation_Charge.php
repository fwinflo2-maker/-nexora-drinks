...
<title>Formulaire de validation d'une charge.</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<fieldset style="width:750px; margin-left:150px; border-color:#FFFBF0" ><legend>Validation d'une charge.</legend>
<table>
<form action="CTRL/Ctrl_Val_Charge.php" method="post" >
<tr>
