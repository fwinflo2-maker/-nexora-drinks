	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Mod_Perte.php",true);
...
$couleur = "darkgray";
			$i = 0;
			$cod='PER';
	$sql='SELECT  * FROM SORTIE_STOCK_FRIGO WHERE ID_SORTIESTOCK LIKE "%'.$cod.'%" AND STATUT="N" ORDER BY ID_SORTIESTOCK DESC LIMIT 0,20' ;
