...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Gerant" || $_SESSION['habilitation']=="Comptable" || $_SESSION['habilitation']=="OPS"))
{
	...
	include("fonctions.php");
		...
		$sql = " select prixvente, observation, qtesortie from articlevendu_frigo where id_sortiestock='".$_GET['Vte']."' and id_article='".$_GET['AR']."'";
...
<title>Formulaire  de suppression des articles d'une Perte.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Article_Perte.php" method="post">
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer un article à une perte</legend>
<table>
<tr>
