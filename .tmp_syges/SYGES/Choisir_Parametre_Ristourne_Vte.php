...
<body>
<form method="post" action="CTRL/Controle_Ristourne_Vte.php" onsubmit="return verif_form()">
<fieldset style="width:800px; margin-left:150px"><legend align="center">Consultation des Ristournes (Sur Ventes)</legend>
<table >
	<tr>
