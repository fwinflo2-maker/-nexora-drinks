	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_An_Val_Vente.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="6"><h5>Liste des ventes pour Annulation Validation</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=An_Val_Vente&Vte=<?php echo $rslt['ID_SORTIESTOCK'];?> &Clt=<?php echo $rslt['ID_CLIENT'];?> "/> <img src="IMG/Select.png"/> </a></td>
