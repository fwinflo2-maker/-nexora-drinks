...
<body>
<form method="post" action="CTRL/Controle_Entree_Stock_Cession_Ar.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation des entrées en stock cession par Ar</legend>
<table >
<tr>
