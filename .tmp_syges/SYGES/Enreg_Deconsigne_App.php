...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Gerant"))
{
	...
	include("fonctions.php");
		...
		$sql = " select id_consigne, id_appro, id_emballage, montant, qte from consigneapp where id_consigne='".$_GET['Id']."'";
...
<form action="CTRL/Ctrl_Deconsigne_App.php" method="post" onsubmit="return verif_form()" >
...
<tr>
    ...
    <td><input type="text" id="codeappro" name="codeappro" value="<?php echo $ap;?>" readonly="readonly" style="background:#ECECEC; width:200px;"/></td>
        <?php
...
<tr>
    ...
    <td><input type="text" id="mt" name="mt" style="width:250px;background:#ECECEC;" value="<?php echo number_format($mt, 0, ',', ' ').' FCFA'; ?>" readonly="readonly"/></td>
</tr>
<tr>
    <td ><label>Date deconsigne *</label></td>
    <td ><input type="text" id="Dat" name="Dat" style="width:110px;" value="<?php echo date('d-m-Y'); ?>"/> 
