...
<title>Consultation de la Liste des Sorties Cession</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="8"><h3>Liste des Sorties Cession </h3></td>
          </tr>
          <tr align="center" bgcolor="#CCCCCC">
...
?>
<tr>
	<td><a href="Liste_SortieCession.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Statut=<?php echo $_GET['Stat'];?>"/><input type="button" value="Imprimer" /></td></a>
