...
<title>Formulaire  d'ajout d'un Prix Vente.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Controle_Ajout_Tarif.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:1050px;"><legend>Ajouter le Prix de vente d'un Article </legend>
<table>
<tr>
...
<tr>
	<td><label for="libar"> Mot Clé (Article) </label></td>
    ...
    <td><input type="text" id="prixvente" name="prixvente" style="width:150px;"/></td>
</tr>
<tr>
