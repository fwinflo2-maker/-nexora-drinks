...
<title>Formulaire  de validation d'une Vente Frigo.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Val_Vente_Frigo.php" method="post">
<fieldset style=" width:1050px;"><legend>Informations sur la vente à valider</legend>
<table >
<tr>
...
<table>
<tr>
    <td align="center" > <a href="index.php?formulaire=Validation_Vente&Vte=<?php echo $rslt2['ID_SORTIESTOCK'];?> "> <input type="submit" name="Valider" id="Valider" value="Valider la vente" style="margin-left:850px; background:#F00;"/> </a></td>
</tr>
</table>
