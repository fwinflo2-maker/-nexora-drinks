...
<title>Formulaire  de validation d'une Perte.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Val_Perte.php" method="post">
...
<table>
<tr>
    <td align="center" > <a href="index.php?formulaire=Validation_Perte&Vte=<?php echo $rslt2['ID_SORTIESTOCK'];?> "> <input type="submit" name="Valider" id="Valider" value="Valider la Perte" style="margin-left:850px; background:#F00;"/> </a></td>
</tr>
</table>
