...
<title>Formulaire  de suppression des articles d'un appro. cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Article_ApproCession.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer un article à un Appro Cession</legend>
<table>
<tr>
