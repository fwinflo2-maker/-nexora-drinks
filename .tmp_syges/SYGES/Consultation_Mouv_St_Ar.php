...
<title>Consultation des mouvements en stocks d'un article</title>
</head>
...
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="9"><h3>Etat des mouvements en stock</h3></td>
          </tr>
          <tr align="center" bgcolor="#CCCCCC">
...
?>
<tr>
	<td align="center"><a href="Etat_Mouv_St_Ar.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Art=<?php echo $_GET['Art'];?>"/><input type="button" value="Imprimer" /></td></a>
	<td colspan="8" align="center"><h4>Nombre de Mouvement :<?php echo $nbre; ?> </h4></td>
</tr>
</table>
</body>
</html>
