...
<title>Formulaire  de modification des articles d'une vente frigo.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Mod_Article_Vente_Frigo.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:750px; margin-left:150px;"><legend>Modifier des articles d'une vente frigo</legend>
<table>
<tr>
