	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_An_Val_Appro.php",true);
...
<body>
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des approvisionnements pour annulation validation</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
$i = 0;
$sql='SELECT  ID_APPRO, DATE_APPRO, ID_FOURNISSEUR, OBSERVATION FROM APPROVISIONNEMENT WHERE STATUT="V" ORDER BY DATE_APPRO DESC LIMIT 0,20 ' ;
		...
		//
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=An_Val_Appro&Ap=<?php echo $rslt['ID_APPRO'];?>&Fs=<?php echo $rslt['ID_FOURNISSEUR'];?>"/> <img src="IMG/Select.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
