...
<title>Formulaire  d'ajout des articles à une vente.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Controle_Ajout_Article_Vente.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:1050px;"><legend>Ajouter des articles à une vente</legend>
<table>
<tr>
...
<tr>
    ...
    <td><select name="codeart" id="codeart" style="width:300px;">
     <?php
	    $sql = " select id_article ,marque,libelle, qtestock from article  where statut='Actif' and id_article not in (select id_article from articlevendu where id_sortiestock ='".$_GET['Vte']."') order by libelle  ";
