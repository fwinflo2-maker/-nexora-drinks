...
?>
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des appro cession pour dévalidation</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_APPRO, DATE_APPRO, LOGIN, OBSERVATION FROM APPROCESSION WHERE ID_APPRO LIKE "%'.$_POST['codeappro'].'%" AND STATUT="V" ORDER BY DATE_APPRO DESC ' ;
		...
		//
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=An_Val_ApproCession&Ap=<?php echo $rslt['ID_APPRO'];?>"/> <img src="IMG/Select.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
