...
<title>Choisir un appro pour Consigne.</title>
	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Cons_Appro.php",true);
...
$couleur = "darkgray";
	...
	$sql='SELECT  A.ID_APPRO, A.DATE_APPRO, A.ID_FOURNISSEUR, F.ID_FOURNISSEUR, F.NOM, A.OBSERVATION FROM APPROVISIONNEMENT A, FOURNISSEUR F WHERE  A.ID_FOURNISSEUR=F.ID_FOURNISSEUR AND  A.STATUT="V" ORDER BY DATE_APPRO DESC ' ;
