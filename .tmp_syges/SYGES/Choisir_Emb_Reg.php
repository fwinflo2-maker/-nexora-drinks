        ...
        function go()
		{
			...
			xhr.onreadystatechange = function()
			{
				...
				if(xhr.readyState == 4 && xhr.status == 200)
				{
					...
					document.getElementById('temb').innerHTML =leselect;
				}
			}
			// Ici on va voir comment faire du post
			xhr.open("POST","Ajax_Reg_St_Emb.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <table id='temb' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des Emballages pour Regularisation des stocks</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
            	
            	<td align="center" width="20%"><h5>Code </h5></td>
                <td  align="center" ><h5>Libelle </h5></td>
                <td  align="center"><h5>Qte Totale </h5></td>
...
$couleur = "darkgray";
$i = 0;	
$sql='SELECT  ID_EMBALLAGE, LIBELLE, QTE, QTESTOCK FROM EMBALLAGE WHERE STATUT="Actif" ORDER BY ID_EMBALLAGE ' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Reg_St_Emb&Id=<?php echo $rslt['ID_EMBALLAGE'];?> "/> <img src="IMG/b_edit.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
