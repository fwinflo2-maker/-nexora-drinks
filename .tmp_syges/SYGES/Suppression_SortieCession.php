...
<title>Formulaire  de suppression d'une Sortie. Cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_SortieCession.php" method="post">

<fieldset style=" width:1050px;"><legend>Informations sur la cession à supprimer</legend>
<table >
<tr>
...
<table id='tarticle' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="4"><h5>Liste des Articles de la cession</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
