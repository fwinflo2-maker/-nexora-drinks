...
<title>Consultation de la Liste des Approvisionnements Frigo</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="8"><h3>Liste des Approvisionnements  </h3></td>
          </tr>
          <tr align="center" bgcolor="#CCCCCC">
          		<td colspan=""><h5>Période d'appro </h5></td>
...
?>
<tr>
	<td><a href="Liste_ApF.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Statut=<?php echo $_GET['Stat'];?>"/><input type="button" value="Imprimer" /></td></a>
