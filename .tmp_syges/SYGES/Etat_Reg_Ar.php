...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Gerant" ))
{
 ...
 $pdf->AddPage();
 $pdf->SetTitle('Etat des régularisations du stock des articles ');
 $pdf->SetAuthor('SYGES');
 $pdf->SetSubject('REGULARISATION');
 $pdf->Ln(5);
 $pdf->SetFont('arial','B',12);
 $pdf->Write(80,'                                                            ETAT DES REGULARISATIONS DU STOCK DES ARTICLES');
 $pdf->Ln(3);
 ...
 $pdf->Cell(55,7,'ARTICLE',1,0,'L',1);
 $pdf->Cell(35,7,'ST MAGASIN AVANT ',1,0,'L',1);
 $pdf->Cell(35,7,'ST MAGASIN APRES',1,0,'L',1);
 $pdf->Cell(35,7,'ST FRIGO AVANT',1,0,'C',1);
 $pdf->Cell(30,7,'ST FRIGO APRES',1,0,'C',1);
  ...
  while($rslt= $reponse->fetch())
 {
  ...
  $pdf->Cell(55,7,$rslt['ID_ARTICLE'].'/'.$libelle,1);
  $pdf->Cell(35,7, $rslt['STOCKMAGAV'],1,0,'C');
  $pdf->Cell(35,7, $rslt['STOCKMAGAP'],1,0,'C');
  $pdf->Cell(35,7,$rslt['STOCKFRAV'],1,0,'C');
  $pdf->Cell(30,7,$rslt['STOCKFRAP'],1,0,'C');
