	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Supp_Perte.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des pertes pour Suppression</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
			$i = 0;
			$cod = 'PER';
	$sql='SELECT  ID_SORTIESTOCK, DATESORTIESTOCK, LOGIN, OBSERVATION FROM SORTIE_STOCK_FRIGO WHERE STATUT="N" AND  ID_SORTIESTOCK LIKE "%'.$cod.'%" ORDER BY ID_SORTIESTOCK DESC LIMIT 0,20' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Suppression_Perte&Vte=<?php echo $rslt['ID_SORTIESTOCK'];?>"/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
