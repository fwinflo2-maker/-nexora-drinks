...
$couleur = "darkgray";
			$i = 0;
	$sql='SELECT  ST.ID_SORTIESTOCK, ST.DATESORTIESTOCK, ST.ID_CLIENT,C.ID_CLIENT, C.NOM, ST.OBSERVATION FROM SORTIE_STOCK ST, CLIENT C WHERE ST.ID_SORTIESTOCK LIKE "%'.$_POST['codevte'].'%" AND ST.ID_CLIENT=C.ID_CLIENT AND  ST.STATUT="N" ORDER BY  ST.DATESORTIESTOCK DESC' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Supprimer_Vente&Vte=<?php echo $rslt['ID_SORTIESTOCK'];?> &Clt=<?php echo $rslt['ID_CLIENT'];?> "/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
