...
<form action="CTRL/Controle_Vente.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:1050px;"><legend>Informations sur la vente</legend>
<table >
<tr>
    <td colspan="6" align="right"><a href="index.php?formulaire=Enreg_Client_Vente"><input type="button" value="Nouveau Client" name="nouveauclient" style="background:#F00;"/> </a></td>
</tr>
<tr>
    <td><label for="codevente"> Code * </label></td>
    <td><input type="text" id="codevente" name="codevente" readonly="readonly" style="width:150px; background-color:#ECECEC" value="<?php echo generer_code_vente();?>"/></td>
...
?>
    ...
    <td><input type="text" id="observationsortie" name="observationsortie" maxlength="35" style="width:280px;"/></td>
</tr>
<tr>
<?php if ($_SESSION['habilitation']=="Administrateur")
{
?>
    ...
    <td><input type="text" id="ristourne" name="ristourne" style="width:150px" value=0></td>
 <?php 
}
else
{
?>
    <td><label for="ristourne"> Crédit Ristourne * </label></td>
    <td><input type="text" id="ristourne" name="ristourne"  style="width:150px; background-color:#ECECEC" readonly="readonly" value=0></td>
<?php 
}
?>
    ...
    <td colspan="3"> <select name="codeclient" id="codeclient" style="width:280px;">
         <?php
...
<tr>
    ...
    <td><select name="codeart" id="codeart" style="width:315px;">
     <?php
	...
	<td><label for="qtevendu"> Quantite  1* </label></td>
...
<tr>
    ...
    <td><select name="codeart2" id="codeart2" style="width:315px;">
     <?php
	    $sql = " select id_article ,marque,libelle, qtestock from article  where statut='Actif' order by libelle  ";
		$reponse= $DataBase->query($sql);
		while($rslt= $reponse->fetch())
...
<tr>
    ...
    <td><select name="codeart3" id="codeart3" style="width:315px;">
     <?php
	    $sql = " select id_article ,marque,libelle, qtestock from article  where statut='Actif' order by libelle  ";
		$reponse= $DataBase->query($sql);
		while($rslt= $reponse->fetch())
