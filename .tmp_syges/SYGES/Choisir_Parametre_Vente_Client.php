...
<title>Parametre pour liste des Achats d'un client</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Vente_Client.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des Achats Client(s)</legend>
<table >
<tr>
