...
<title>Formulaire  de validation d'un Versement.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Val_Vers.php" method="post">
<fieldset style=" width:1050px;"><legend>Informations sur le Versement à valider</legend>
<table >
<tr>
...
<table>
<tr>
    <td align="center" > <input type="submit" name="Valider" id="Valider" value="Valider" style="margin-left:850px; background:#F00;"/></td>
</tr>
</table>
