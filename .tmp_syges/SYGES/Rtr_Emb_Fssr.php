...
<title>Formulaire  d'ajout d'un retour emballage.</title>
<style type="text/css">
label
{
	display:block;
...
<script src="JS/Ajout_Emb_Rtr.js" type="text/javascript"></script>
...
<form action="CTRL/Ctrl_Ajout_Emb_Rtr.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:900px; margin-left:80px;"><legend>Ajout d'un retour d'emballage à un Approvisionnement</legend>
<table>
<tr>
	<td><label for="codeappro">Appro *</label> </td>
    <td><input type="text" id="codeappro" name="codeappro" value="<?php echo $_GET['Ap']?>" readonly="readonly" style="background:#ECECEC; width:100px;"/></td>
...
<tr>
    ...
    <td><select name="Emb" id="Emb" style="width:200px;">
     <?php
	    $sql = " select id_emballage,libelle from emballage  where statut='Actif' and id_emballage not in (select id_emballage from rtrembfssr where id_appro ='".$_GET['Ap']."') order by libelle  ";
