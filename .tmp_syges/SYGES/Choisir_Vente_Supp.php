	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Supp_Vente.php",true);
...
$couleur = "darkgray";
	...
	$sql='SELECT  ST.ID_SORTIESTOCK, ST.DATESORTIESTOCK, ST.ID_CLIENT,C.ID_CLIENT, C.NOM, ST.OBSERVATION FROM SORTIE_STOCK ST, CLIENT C WHERE  ST.ID_CLIENT=C.ID_CLIENT AND  ST.STATUT="N" ORDER BY ST.DATESORTIESTOCK DESC LIMIT 0,20' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Suppression_Vente&Vte=<?php echo $rslt['ID_SORTIESTOCK'];?> &Clt=<?php echo $rslt['ID_CLIENT'];?> "/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
