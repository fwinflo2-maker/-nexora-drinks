...
while($rslt2= $reponse2->fetch())
{
	...
	//calcul des valeurs pr l'article
		...
		$valeurR=number_format($tauxristournettc, 0, ',', ' ')*number_format($qterecu, 0, ',', ' ');
...
<table id='participationristourne' border="1" width="100%" align="center">
          <tr align="center">
            ...
            <tr bgcolor="#CCCCCC">
                <td align="center"><h5>VALEUR </h5> </td>
                <td align="center"><h5>MT TVA</h5> </td>
                <td align="center"><h5>RETENU FISC(<?php echo $tauxretfiscpro; ?>%)</h5> </td>
...
<table id='ristournesnettes' border="1" width="100%" align="center">
       ...
       <?php
			...
			$ttristournesnettes=$TTvaleurttcR+$valeurepargneachat-$ttretenues+$ttregularisations;
	  ?>
      		<tr bgcolor="#CCCCCC">
