...
<title>Parametre Consultation rtr emb</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Etat_RtrEmb.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des retours d'emballages au fournisseur</legend>
<table >
<tr>
