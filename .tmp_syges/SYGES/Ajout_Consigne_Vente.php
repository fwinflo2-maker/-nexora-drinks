<?php
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Comptable" || $_SESSION['habilitation']=="OPS"))
{
...
<form action="CTRL/Ctrl_Ajout_Consigne_Vente.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:750px; margin-left:150px;"><legend>Ajout d'une consigne à une vente</legend>
<table>
<tr>
...
<tr>
    ...
    <td><select name="Emb" id="Emb" style="width:220px;">
     <?php
	    $sql = " select id_emballage,libelle from emballage  where statut='Actif' and id_emballage not in (select id_emballage from consigne where id_sortiestock ='".$_GET['Vte']."') order by libelle  ";
...
<tr>
    ...
    <td><input type="text" id="Date" name="Date" style="width:125px;"/><input type="button" value="Calendrier" onclick="displayCalendar(document.forms[0].Date,'dd/mm/yyyy',this)" />
    </td>
</tr>
<tr>
