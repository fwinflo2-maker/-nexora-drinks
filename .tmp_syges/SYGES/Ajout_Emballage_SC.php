...
<title>Formulaire  d'ajout d'un Emballage à une Sortie Cession</title>
<style type="text/css">
label
{
	display:block;
...
<script src="JS/Ajout_Emballage_SC.js" type="text/javascript"></script>
...
<form action="CTRL/Ctrl_Ajout_Emballage_SC.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:1050px;"><legend>Ajout d'un Emballage à une Sortie Cession</legend>
<table>
<tr>
	<td><label for="codesortie">Cession *</label> </td>
    <td><input type="text" id="codesortie" name="codesortie" value="<?php echo $_GET['SC']?>" readonly="readonly" style="background:#ECECEC; width:150px;"/></td>
    </td>
</tr>
<tr>
