...
<form action="CTRL/Ctrl_Ajout_Consigne_App.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:900px; margin-left:80px;"><legend>Ajout d'une consigne à un Approvisionnement</legend>
<table>
<tr>
...
<tr>
    ...
    <td><select name="Emb" id="Emb" style="width:200px;">
     <?php
	    $sql = " select id_emballage,libelle from emballage  where statut='Actif' and id_emballage not in (select id_emballage from consigneapp where id_appro ='".$_GET['Ap']."') order by libelle  ";
