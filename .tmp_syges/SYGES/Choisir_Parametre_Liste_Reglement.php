...
<script src="JS/Consultation_Liste_Reglement.js" type="text/javascript"></script>
<link type="text/css" rel="stylesheet" href="dhtmlgoodies_calendar/dhtmlgoodies_calendar.css?random=20051112" media="screen" />
	<script type="text/javascript" src="dhtmlgoodies_calendar/dhtmlgoodies_calendar.js?random=20060118"></script>
</head>

<body>
<form method="post" action="CTRL/Controle_Liste_Reglement.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation des Reglements Factures Ventes</legend>
<table >
<tr>
   ...
   <tr>
        ...
        <td><input type="checkbox" id="Avance" name="Avance" />
   		<label for="Instance" > Avance </label></td>
        <td colspan="2" ><input type="checkbox" id="Paye" name="Paye" />
        <label for="Valide" > Paye </label></td>
   </tr>
   <tr>
