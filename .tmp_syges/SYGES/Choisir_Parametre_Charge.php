...
<title>Parametre pour etat des charges</title>
<style type="text/css">
label
{
	display:block;
...
<script src="JS/Consultation_Etat_Charge_Type.js" type="text/javascript"></script>
<link type="text/css" rel="stylesheet" href="dhtmlgoodies_calendar/dhtmlgoodies_calendar.css?random=20051112" media="screen" />
	<script type="text/javascript" src="dhtmlgoodies_calendar/dhtmlgoodies_calendar.js?random=20060118"></script>
</head>

<body>
<form method="post" action="CTRL/Controle_Etat_Charge_Type.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'etat des charges par type</legend>
<table >
<tr>
	<td align="left"><label for="codetcharge"> Charge :</label></td>
    <td><select name="codetcharge" id="codetcharge" style="width:200px;">
    <?php
    	$sql = " select id_typecharge, libelle from type_charge  order by libelle  ";
