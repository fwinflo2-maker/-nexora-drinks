...
<title>Consultation de l'etat des clients</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h3>Liste des clients  </h3></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
?>
<tr>
	<td><a href="Liste_Client.php"/><input type="button" value="Imprimer" /></td></a>
	<td colspan="5" align="right"><h4>Nombre de client:<?php echo $nbre; ?> </h4></td>
</tr>
</table>
</body>
</html>
