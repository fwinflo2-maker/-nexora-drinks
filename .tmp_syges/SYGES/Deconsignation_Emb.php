...
<title>Formulaire  d'ajout d'une deconsignation emballage.</title>
<style type="text/css">
label
{
	display:block;
...
<script src="JS/Ajout_Emb_Rtr_Vte.js" type="text/javascript"></script>
...
<form action="CTRL/Ctrl_Ajout_Emb_Rtr_Vte.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:900px; margin-left:80px;"><legend>Ajout d'une Deconsignation d'emballage à une Vente</legend>
<table>
<tr>
	<td><label for="codevente">Code Vente *</label> </td>
