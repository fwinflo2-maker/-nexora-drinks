...
<title>Parametre Pour CA CLIENT</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_CA_Client.php" onSubmit="return verif_form()">
<fieldset style="width:800px; margin-left:150px"><legend align="center">CA CLIENTS </legend>
<table >
	<tr>
