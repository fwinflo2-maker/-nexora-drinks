...
<body>
<form method="post" action="CTRL/Controle_Sortie_Stock_Cession_Ar.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation des sorties cession par article</legend>
<table >
<tr>
