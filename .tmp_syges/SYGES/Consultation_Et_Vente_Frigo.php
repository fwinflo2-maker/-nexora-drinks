...
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="6"><h3>Etat des ventes frigo par article</h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
...
?>
<tr>
	<td><a href="Etat_Vente_Frigo.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>"/><input type="button" value="Imprimer" /></td></a>
