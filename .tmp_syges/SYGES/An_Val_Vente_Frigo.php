...
<title>Formulaire  d'annulation d'une Vente Frigo.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_An_Val_Vente_Frigo.php" method="post">
...
<table>
<tr>
    <td align="center" > <input type="submit" name="Annuler" id="Annuler" value="Annuler la vente" style="margin-left:850px; background:#F00;"/></td>
</tr>
</table>
<table id='tarticle' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="7"><h5>Liste des Articles de la vente frigo</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
