...
<title>Formulaire d'enreg. d'une Vente.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Controle_Consigne.php" method="post" onsubmit="return verif_form()" >
<fieldset style="width: 1050px;"> <legend>Informations sur la vente </legend>
<table>
<tr>
    <td><label for="nomclient"> Client  </label></td>
    <td><input type="text" id="nomclient" name="nomclient"  value="<?php echo $rslt['NOM']; ?> / <?php echo $rslt['ID_CLIENT']; ?>" readonly="readonly" style="width:200px; background:#ECECEC;"/></td>
...
<tr>
    ...
    <td><input type="text" id="date_vente" name="date_vente" style="width:200px; background:#ECECEC;" value="<?php echo dateFormatFrancais($rslt2['DATESORTIESTOCK']); ?>"/>
	<td><label for="observationsortie"> Observation  </label></td>
    <td><input type="text" id="observationsortie" name="observationsortie" maxlength="35" style="width:200px; background:#ECECEC;" value="<?php echo $rslt2['OBSERVATION']; ?>" readonly="readonly"/></td>
</tr>
</table>
</fieldset>
...
<table>
<tr>
	<td align="center" > <a href="index.php?formulaire=Ajout_Consigne_Vente&Vte=<?php echo $rslt2['ID_SORTIESTOCK'];?> "> <input type="button" name="ajoutcons" id="ajoutcons" value="Ajouter des consignes à la vente" style="margin-left:750px; width:210px"/> </a></td>
</tr>
</table>

<table id='tconsigne' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="8"><h5>Liste des Consignes de la vente</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
		...
		while($rslt3= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Enreg_Deconsigne&Vte=<?php echo $rslt2['ID_SORTIESTOCK']; ?>&Emb=<?php echo $rslt3['ID_EMBALLAGE']; ?> "/> <img src="IMG/b_edit.png"/> </a></td>
                        <td  align="center"> <a href="index.php?formulaire=Supp_Consigne_Vente&Vte=<?php echo $rslt2['ID_SORTIESTOCK']; ?>&Emb=<?php echo $rslt3['ID_EMBALLAGE']; ?> "/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
