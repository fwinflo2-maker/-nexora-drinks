...
<body>
<form method="post" action="CTRL/Controle_Etat_Consigne.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des consignes</legend>
<table >
<tr>
