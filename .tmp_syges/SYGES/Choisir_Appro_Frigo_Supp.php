...
<title>Choisir un Approvisionnement Frigo pour suppression.</title>
	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Supp_Appro_Frigo.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des Approvisionnements Frigo pour Suppression</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
		...
		//
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Supp_Appro_Frigo&Ap=<?php echo $rslt['ID_APPRO'];?>"/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
