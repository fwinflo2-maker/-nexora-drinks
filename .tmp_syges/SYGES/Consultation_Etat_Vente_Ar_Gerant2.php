...
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h3>Etat des ventes par Article</h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
...
$qterecu=0;
$PV=0;
$sql1 = 'SELECT  AR.ID_ARTICLE, AR.QTESORTIE,AR.PRIXVENTE, AR.ID_SORTIESTOCK, ST.ID_SORTIESTOCK, ST.DATESORTIESTOCK FROM ARTICLEVENDU AR, SORTIE_STOCK ST WHERE AR.ID_SORTIESTOCK=ST.ID_SORTIESTOCK AND ST.DATESORTIESTOCK BETWEEN "'.$Debut.'" AND "'.$Fin.'" AND AR.ID_ARTICLE="'.$rslt['ID_ARTICLE'].'" AND ST.STATUT="V"';
		...
		while($rslt2= $reponse2->fetch())
		{
			...
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <?php echo number_format($PV, 0, ',', ' ').' F'; ?> </td>
                     </tr>
                <?php
				$i++;
				$nbre++;
...
?>
<tr>
	<td><a href="Etat_Vente_Article_Gerant.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>"/><input type="button" value="Imprimer" /></td></a>
	<td colspan="" align="center"><h4>Nombre d'article:<?php echo $nbre; ?> </h4></td>
    <td colspan="" align="center"><h4>Totaux :  </h4></td>
    <td colspan="" align="center"><h4><?php echo $QTET; ?></h4></td>
    <td colspan="" align="center"><h4><?php echo number_format($MT, 0, ',', ' ').' F'; ?> </h4></td>
</tr>
</table>
</body>
</html>
