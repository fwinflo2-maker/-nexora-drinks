...
<body>
<form method="post" action="CTRL/Controle_Entree_Stock_Frigo.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des entrées en stock frigo</legend>
<table >
<tr>
