...
<title>Formulaire  de modification des articles d'un appro.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Mod_Article_Appro_Frigo.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:750px; margin-left:150px;"><legend>Modifier des articles à un Appro Frigo</legend>
<table>
<tr>
...
<tr>
     <?php
	   $sql='SELECT  ID_ARTICLE, LIBELLE, NBREBTE FROM ARTICLE WHERE ID_ARTICLE="'.$_GET['AR'].'" ' ;
    ...
    <td><input type="text" id="qterecu" name="qterecu" style="width:200px;" value="<?php echo $_GET['QTE']?>"/></td>
</tr>
<tr>
