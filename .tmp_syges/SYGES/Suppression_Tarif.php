...
<title>Formulaire  de suppression des prix de vente</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Tarif.php" method="post" onsubmit="return verif_form()" >
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer un Prix de Vente</legend>
<table>
<tr>
...
<tr>
    ...
    <td><input type="text" id="prixvente" name="prixvente" style="background:#ECECEC; width:200px;" value="<?php echo $_GET['Pv']?>" readonly="readonly"/></td>
</tr>
<tr>
