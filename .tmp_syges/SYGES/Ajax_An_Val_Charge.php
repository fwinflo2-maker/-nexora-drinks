...
$couleur = "darkgray";
$i = 0;
$sql='SELECT C.ID_CHARGE, TC.LIBELLE, TC.ID_TYPECHARGE, C.ID_TYPECHARGE, C.DESCRIPTION, C.MONTANT, C.DATE_CHARGE FROM CHARGE C, TYPE_CHARGE TC WHERE C.ID_TYPECHARGE=TC.ID_TYPECHARGE  AND C.STATUT="V" AND C.ID_CHARGE LIKE "%'.$_POST['code'].'%" ORDER BY C.DATE_CHARGE DESC' ;
