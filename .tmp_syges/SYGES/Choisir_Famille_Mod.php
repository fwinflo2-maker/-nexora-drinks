        ...
        function go()
		{
			...
			xhr.onreadystatechange = function()
			{
				...
				if(xhr.readyState == 4 && xhr.status == 200)
				{
					...
					document.getElementById('tfamille').innerHTML =leselect;
				}
			}
			// Ici on va voir comment faire du post
			xhr.open("POST","Ajax_Mod_Famille.php",true);
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_FAMILLE, LIBELLE, STATUT FROM FAMILLE ORDER BY LIBELLE ' ;
