...
<table id='liste' border="1" width="100%" align="center">
          ...
          <td colspan=""><h3></h3></td>
          	<td colspan="5"><h3>Etat des ventes Magasin par Article</h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
          		<td align="center"><a href="Etat_Vente_Article_Gerant.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&user=<?php echo $_GET['user'];?>"/><input type="button" style="background:#FF8000" value="Imprimer" /></a></td>
                <td colspan="2"><h4>Utilisateur : <?php echo $_GET['user']; ?></h4></td>
                <td colspan="2" align="center" ><h5>Période Du : <?php echo dateFormatFrancais($Debut); ?>  Au : <?php echo dateFormatFrancais($Fin); ?></h5>
                </td>
...
<tr>
    ...
    <td colspan="1" align="center"><h4>Deconsignations Clients(4) :  <?php echo number_format($mtrevte, 0, ',', ' ').' F'; ?> </h4></td>

</tr>
<tr>

	<td colspan="5" align="center"><h4>Montant Total(1)+(2)+(3)-(4) :  <?php echo number_format($TTPV+$fraisenlevement+$mtcc-$mtrevte, 0, ',', ' ').' F'; ?> </h4></td>
