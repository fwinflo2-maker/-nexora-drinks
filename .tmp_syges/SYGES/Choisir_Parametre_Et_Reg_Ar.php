...
<body>
<form method="post" action="CTRL/Controle_Et_Reg_Ar.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'etat des Regularisations des Articles</legend>
<table >
<tr>
