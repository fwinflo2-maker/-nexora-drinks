...
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h3>Etat des pertes par article</h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
            ...
            <tr bgcolor="#CCCCCC">
                ...
                <td  align="center"><h5>Qté Perdu </h5></td>
...
?>
<tr>
	<td><a href="Etat_Perte_Gerant.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>"/><input type="button" value="Imprimer" /></td></a>
	<td colspan="4" align="right"><h4>Montant Total : <?php echo $MT.' FCFA'; ?> </h4></td>
</tr>
</table>
</body>
</html>
