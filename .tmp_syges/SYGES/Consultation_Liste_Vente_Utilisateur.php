...
?>
<tr>
	<td><a href="Liste_Vente_Utilisateur.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Statut=<?php echo $_GET['Stat'];?>&user=<?php echo $_GET['user'];?>"/><input type="button" value="Imprimer" /></td></a>
