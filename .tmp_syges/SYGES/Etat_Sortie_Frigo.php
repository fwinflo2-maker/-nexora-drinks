...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Gerant"  || $_SESSION['habilitation']=="Comptable"))
{
 ...
 $pdf->Write(80,'                          ETAT DES SORTIES DE STOCK FRIGO');
 $pdf->Ln(2);
 $pdf->Write(80,'                          __________________________________');
 $pdf->Ln(45);                                
 ...
 $pdf->Cell(40,7,'QTE SORTIE(BTLLE)',1,0,'C',1);
  $pdf->Cell(40,7,'QTE EN STOCK (BTLLE)',1,1,'C',1);
 $pdf->SetFont('Arial','',8);
 $pdf->SetTextColor(0,0,0);
...
$sql2 = 'SELECT ID_ARTICLE, LIBELLE, MARQUE,NBREBTE, STOCKFRIGO FROM ARTICLE WHERE ID_ARTICLE="'.$rslt['ID_ARTICLE'].'"';
