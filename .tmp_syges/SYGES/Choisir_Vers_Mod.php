	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Mod_Vers.php",true);
...
<input type="button" value="Afficher" name="aff" onClick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="7"><h5>Liste des Versements pour Modification</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  V.NUM_VERS, V.DATE_VERS, V.VENDEUR,VD.LOGIN, VD.NOM, V.OBSERVATION, V.MONTANT FROM VERSEMENT V, USER VD WHERE  V.VENDEUR=VD.LOGIN AND  V.STATUT="N" ORDER BY V.DATE_VERS DESC LIMIT 0,20' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Modification_Vers&Vers=<?php echo $rslt['NUM_VERS'];?> &VD=<?php echo $rslt['LOGIN'];?> "/> <img src="IMG/b_edit.png"/> </a></td>
                        <td  align="center"> <a href="index.php?formulaire=Validation_Vers&Vers=<?php echo $rslt['NUM_VERS'];?> &VD=<?php echo $rslt['LOGIN'];?> "/> <img src="IMG/Liste.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
