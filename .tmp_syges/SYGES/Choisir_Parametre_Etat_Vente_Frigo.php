...
<body>
<form method="post" action="CTRL/Controle_Et_Vente_Frigo.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation des Ventes Frigo par Article</legend>
<table >
<tr>
