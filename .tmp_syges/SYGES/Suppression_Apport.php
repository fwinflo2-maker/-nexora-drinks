...
<title>Formulaire de suppression d'un Mouvement de fonds.</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<fieldset style="width:750px; margin-left:150px; border-color:#FFFBF0" ><legend>Suppression d'un Mouvement de fonds.</legend>
<table>
<form action="CTRL/Ctrl_Supp_Apport.php" method="post" >
<tr>
