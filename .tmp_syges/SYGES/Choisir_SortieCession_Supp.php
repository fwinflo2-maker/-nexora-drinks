	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Supp_SortieCession.php",true);
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_SORTIESTOCK, DATESORTIESTOCK, LOGIN, OBSERVATION FROM SORTIE_STOCK_CESSION WHERE STATUT="N" ORDER BY DATESORTIESTOCK DESC LIMIT 0,20' ;
