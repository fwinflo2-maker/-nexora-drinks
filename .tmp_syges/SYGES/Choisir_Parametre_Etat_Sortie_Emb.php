...
<body>
<form method="post" action="CTRL/Controle_Sortie_Stock_Emb.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'etat des sorties de stock des Emballages</legend>
<table >
<tr>
