...
<body>
<form method="post" action="CTRL/Controle_Sortie_Stock_Frigo.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des sorties de stock frigo</legend>
<table >
<tr>
