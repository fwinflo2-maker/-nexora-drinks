...
<form action="CTRL/Ctrl_Mod_Vente_Frigo.php" method="post" onsubmit="return verif_form()" >

<fieldset style=" width:1050px;"><legend>Informations sur la vente frigo à modifier</legend>
<table >
<tr>
...
<table>
<tr>
	<td align="center" > <a href="index.php?formulaire=Validation_Vente_Frigo&Vte=<?php echo $rslt2['ID_SORTIESTOCK'];?>&Clt=<?php echo $rslt['ID_CLIENT'];?> "> <input type="button" name="Valider" id="Valider" value="Fin de Saisie" style="margin-left:10px; background:#F00;"/> </a></td>
	<td align="center" > <a href="index.php?formulaire=Ajout_Article_Vente_Frigo&Vte=<?php echo $rslt2['ID_SORTIESTOCK'];?> "> <input type="button" name="ajoutart" id="ajoutart" value="Ajouter des articles à la vente" style="margin-left:650px; width:210px"/> </a></td>
</tr>
</table>
<table id='tarticle' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="7"><h5>Liste des Articles de la vente </h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
		...
		while($rslt3= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Modifier_Article_Vente_Frigo&AR=<?php echo $rslt3['ID_ARTICLE'];?>&Vte=<?php echo $rslt3['ID_SORTIESTOCK']; ?>&Qte=<?php echo $rslt3['QTESORTIE'];?> "/> <img src="IMG/b_edit.png"/> </a></td>
                        <td  align="center"> <a href="index.php?formulaire=Supprimer_Article_Vente_Frigo&AR=<?php echo $rslt3['ID_ARTICLE'];?>&Vte=<?php echo $rslt3['ID_SORTIESTOCK']; ?>"/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
