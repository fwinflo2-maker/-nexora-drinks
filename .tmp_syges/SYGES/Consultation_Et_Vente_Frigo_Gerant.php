...
<title>Consultation de l'etat des ventes frigo par article</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h3>Etat des ventes frigo par article</h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
		...
		while($rslt2= $reponse2->fetch())
		{
			...
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <?php echo $PV.' FCFA'; ?> </td>
                     </tr>
                <?php
				$i++;
				$nbre++;
...
?>
<tr>
	<td><a href="Etat_Vente_Frigo_Gerant.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>"/><input type="button" value="Imprimer" /></td></a>
	<td colspan="4" align="right"><h4>Montant Total : <?php echo number_format($MT, 0, ',', ' ').' FCFA'; ?> </h4></td>
</tr>
</table>
</body>
</html>
