...
<body>
<fieldset style="width:400px; margin-left:30%; border-color:#FFFBF0" ><legend>Enregistrement d'une Categorie Client</legend>
<table>
<form action="CTRL/Controle_Categorie.php" method="post" onsubmit="return verif_form()">
<tr>
...
<tr>
    ...
    <td><input type="text" id="RetFiscPro" name="RetFiscPro" style="width:250px"/></td>
</tr>
<tr>
    <td><label for="tva"> TVA(%) *</label></td> 
    <td><input type="text" id="tva" name="tva" style="width:250px"/></td>
</tr>
<tr>
