...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur"))
{
	...
	include("fonctions.php");
		...
		$sql = " select id_appro, id_emballage, qte from consignecession where id_consigne='".$_GET['Id']."'";
...
<title>Formulaire  de suppression de la consigne d'un appro. cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Emballage_APC.php" method="post">
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer une consigne à un appro cession</legend>
<table>
<tr>
