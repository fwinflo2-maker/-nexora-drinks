...
<title>Formulaire  de validation d'un Appro frigo.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_val_Appro_Frigo.php" method="post">

<fieldset style=" width:1060px;"><legend>Informations sur l'approvisionnement à valider</legend></fieldset>
<table >
<tr>
