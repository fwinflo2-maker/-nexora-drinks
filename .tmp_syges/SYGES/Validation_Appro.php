...
<title>Formulaire  de validation d'un Appro.</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_val_Appro.php" method="post">
<fieldset style=" width:1060px;"><legend>Informations sur l'approvisionnement à valider</legend>
<table >
<tr>
...
<tr>
    <td colspan="8" align="right"><input type="submit" align="left" value="Valider" id="Valider" name="Valider" style="background:#F00; width:150px"/></td>
</tr>
...
<table id='tconsigne' border="0" width="100%" align="center">
          <tr align="center" >
          	<td colspan="6"><h5>Liste des Consignes de l'Appro</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$i = 0;
$MTC=0;			
$sql='SELECT  E.ID_EMBALLAGE, E.LIBELLE, E.MT_CONSIGNE, CA.MONTANT, E.ID_EMBALLAGE ,CA.ID_APPRO ,CA.QTE, CA.STATUT FROM EMBALLAGE E, CONSIGNEAPP CA WHERE CA.ID_EMBALLAGE =E.ID_EMBALLAGE AND CA.ID_APPRO="'.$_GET['Ap'].'" ORDER BY CA.ID_EMBALLAGE ' ;
	$reponse= $DataBase->query($sql);
		while($rslt3= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Supp_Consigne_App&Ap=<?php echo $rslt2['ID_APPRO']; ?>&Emb=<?php echo $rslt3['ID_EMBALLAGE']; ?> "/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
...
<tr bgcolor="#E0E0E0" style="visibility:hidden"> 
    <td align="center" colspan="8" style="visibility:hidden"><h4><input type="text" id="totalcolis" name="totalcolis" value="<?php echo $nbrear; ?>"/> </h4></td>
</tr>
</table>
</form>
</body>
