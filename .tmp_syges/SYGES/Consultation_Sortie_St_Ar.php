...
<title>Consultation de l'etat des Sorties en stocks d'un article</title>
</head>

<body>
<table id='liste' border="1" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="9"><h3>Etat des Sorties en stocks</h3></td>
          </tr>
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="9"><h3>Article : <?php echo $libelle ?></h3></td>
          </tr>
          <tr bgcolor="#CCCCCC">
                <td colspan="9" align="center" ><h5>Période : <?php echo dateFormatFrancais($Debut); ?> Au : <?php echo dateFormatFrancais($Fin); ?></h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
if ($libelle=="Tous")
{
	$sql1 = 'select * from mouvementar m, article a where m.id_article=a.id_article and m.id_article=a.id_article and  m.date between "'.$Debut.'" AND "'.$Fin.'" and m.si > m.sf order by m.id_mouv';
}else {
	$sql1 = 'select * from mouvementar m, article a where m.id_article=a.id_article and m.id_article="'.$_GET['Art'].'" and m.id_article=a.id_article and  m.date between "'.$Debut.'" AND "'.$Fin.'" and m.si > m.sf order by m.id_mouv';
}
...
?>
<tr>
	<td><a href="Etat_Sortie_St_Ar.php?debut=<?php echo $_GET["DateD"];?>&fin=<?php echo $_GET["DateF"];?>&Art=<?php echo $_GET['Art'];?>"/><input type="button" value="Imprimer" /></td></a>
