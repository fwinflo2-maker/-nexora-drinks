...
<title>Parametres pour Etat Apports Financiers</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Liste_Apport.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'etat des Apports Financiers</legend>
<table >
<tr>
