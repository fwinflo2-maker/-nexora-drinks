...
<title>Parametre Pour Brouillard vte</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Brouillard_Vte.php" onsubmit="return verif_form()">
<fieldset style="width:750px; margin-left:150px"><legend>Consultation Brouillard des Ventes</legend>
<table >
	<tr>
