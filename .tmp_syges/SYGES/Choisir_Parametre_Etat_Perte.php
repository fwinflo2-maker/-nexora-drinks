...
<body>
<form method="post" action="CTRL/Controle_Et_Perte.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation des Pertes</legend>
<table >
<tr>
