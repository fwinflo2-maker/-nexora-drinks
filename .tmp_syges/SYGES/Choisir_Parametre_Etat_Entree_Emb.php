...
<body>
<form method="post" action="CTRL/Controle_Entree_Stock_Emb.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de l'état des entrées en stock des Emballages</legend>
<table >
<tr>
