...
<title>Parametre Pour Remise</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Remise.php" onsubmit="return verif_form()">
<fieldset style="width:750px; margin-left:150px"><legend>Consultation des Remises</legend>
<table >
	<tr>
