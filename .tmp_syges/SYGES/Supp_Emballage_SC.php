...
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur"))
{
	...
	include("fonctions.php");
			...
			//ON RECUPERE lES INFOS SUR LA CONSIGNE
		$sql = " select id_sortiestock, id_emballage, qte from emballagesortiecession where id_consigne='".$_GET['Id']."'";
		$reponse= $DataBase->query($sql);
		while($rslt= $reponse->fetch())
		{
			$QTE=$rslt['qte'];
			$em=$rslt['id_emballage'];
			$sortie=$rslt['id_sortiestock'];
		}
?>
...
<title>Formulaire  de suppression de la consigne d'une sortie cession</title>
<style type="text/css">
label
{
	display:block;
...
<form action="CTRL/Ctrl_Supp_Emballage_SC.php" method="post">
<fieldset style=" width:750px; margin-left:150px;"><legend>Supprimer une consigne à une sortie cession</legend>
<table>
<tr>
	...
	<td><label for="codesortie">Cession *</label> </td>
    <td><input type="text" id="codesortie" name="codesortie" value="<?php echo $sortie;?>" readonly="readonly" style="background:#ECECEC; width:250px;"/></td>
</tr>
<tr>
     <?php
