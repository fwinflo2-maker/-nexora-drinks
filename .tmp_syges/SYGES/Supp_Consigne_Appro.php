<?php
if (isset ($_SESSION['habilitation']) && ($_SESSION['habilitation']=="Administrateur" || $_SESSION['habilitation']=="Magasinier"))
{
...
<form action="CTRL/Ctrl_Supp_Consigne_Appro.php" method="post">
