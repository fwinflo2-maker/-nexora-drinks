...
<body>
<form action="CTRL/Controle_Client_vente.php" method="post" onsubmit="return verif_form()">
...
<tr>
    ...
    <td><input type="text" id="fraisenlevement" name="fraisenlevement" style="width:150px;"/> </td>
</tr>
</table>
</fieldset>
