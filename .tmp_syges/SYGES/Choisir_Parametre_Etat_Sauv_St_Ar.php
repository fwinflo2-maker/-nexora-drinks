...
<body>
<form method="post" action="CTRL/Controle_Sauv_St_Ar.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation des sauvegardes du stock des articles</legend>
<table >
<tr>
