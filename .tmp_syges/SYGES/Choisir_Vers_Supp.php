	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Supp_Vers.php",true);
...
<input type="button" value="Afficher" name="aff" onClick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="6"><h5>Liste des Versements pour Suppression</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Suppression_Vers&Vers=<?php echo $rslt['NUM_VERS'];?> &VD=<?php echo $rslt['LOGIN'];?> "/> <img src="IMG/Supp.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
