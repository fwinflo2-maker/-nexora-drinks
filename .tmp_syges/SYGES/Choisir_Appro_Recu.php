	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Appro_Recu.php",true);
...
<input type="button" value="Afficher" name="aff" onclick="go()" />
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="5"><h5>Liste des approvisionnements pour impression de l'etat</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_APPRO, DATE_APPRO, ID_FOURNISSEUR, OBSERVATION FROM APPROVISIONNEMENT ORDER BY DATE_APPRO DESC ' ;
		...
		//
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="Recu_Appro.php?Id=<?php echo $rslt['ID_APPRO'];?>"/> <img src="IMG/Select.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
