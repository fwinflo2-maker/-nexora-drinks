	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_Mod_Appro.php",true);
...
$couleur = "darkgray";
	...
	$sql='SELECT  ID_APPRO, DATE_APPRO, ID_FOURNISSEUR, OBSERVATION FROM APPROVISIONNEMENT WHERE STATUT="N" ORDER BY DATE_APPRO DESC LIMIT 0,20' ;
		...
		//
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=Modification_Appro&Ap=<?php echo $rslt['ID_APPRO'];?>"/> <img src="IMG/b_edit.png"/> </a></td>
                        <td  align="center"> <a href="index.php?formulaire=Validation_Appro&Ap=<?php echo $rslt['ID_APPRO'];?> &Fs=<?php echo $rslt['ID_FOURNISSEUR'];?> "/> <img src="IMG/Liste.png"/> </a></td>
                     </tr>
                <?php
				$i++;
		 }
