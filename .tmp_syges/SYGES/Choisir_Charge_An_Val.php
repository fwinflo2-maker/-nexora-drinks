...
<title>Choisir une charge.</title>
	...
	function getXhr()
        ...
        */
        function go()
		{
			...
			xhr.open("POST","Ajax_An_Val_Charge.php",true);
...
<body>
          ...
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="6"><h5>Liste des charges pour annulation validation</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
$i = 0;
$sql='SELECT C.ID_CHARGE, TC.LIBELLE, TC.ID_TYPECHARGE, C.ID_TYPECHARGE, C.DESCRIPTION, C.MONTANT, C.DATE_CHARGE FROM CHARGE C, TYPE_CHARGE TC WHERE C.ID_TYPECHARGE=TC.ID_TYPECHARGE  AND C.STATUT="V" ORDER BY C.DATE_CHARGE DESC LIMIT 0,20' ;
		...
		while($rslt= $reponse->fetch())
		{
			if ($i%2 == 0)
				...
				?>
                        ...
                        <td  align="center"> <a href="index.php?formulaire=An_Val_Charge&Id=<?php echo $rslt['ID_CHARGE'];?> "/> <img src="IMG/Select.png"/> </a></td>
                <?php
				$i++;
		 }
				?>
