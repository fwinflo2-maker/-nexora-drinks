...
<title>Parametre Consultation deconsigne</title>
<style type="text/css">
label
{
	display:block;
...
<body>
<form method="post" action="CTRL/Controle_Etat_Deconsigne.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des deconsignations</legend>
<table >
<tr>
