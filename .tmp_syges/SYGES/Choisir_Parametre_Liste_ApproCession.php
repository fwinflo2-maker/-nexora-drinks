...
<body>
<form method="post" action="CTRL/Controle_Liste_ApproCession.php" onsubmit="return verif_form()">
<fieldset style="width:610px; margin-left:250px"><legend>Consultation de la liste des Appro. Cession</legend>
<table >
<tr>
