...
<script src="JS/Consultation_Mouv_St_Ar.js" type="text/javascript"></script>
...
<body>
<form method="post" action="CTRL/Controle_Mouv_St_Ar.php" onsubmit="return verif_form()">
<fieldset style="margin-left:250px; width:600px;"><legend>Consultation des Mouvements en stock d'un Article</legend>
<table>
<tr>
	<td><label for="libar"> Mot Clé  </label></td>
    <td><input type="text" id="libar" name="libar" style="width:200px;" onchange="go()"/></td>
    <td><label for="libar"> Article  </label></td>
    <td> <select name="codeart" id="codeart" style="width:200px;">
		<option>Tous</option>
    <?php
    	$sql = " select id_article ,libelle from article order by libelle  ";
