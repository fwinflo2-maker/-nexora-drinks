...
<form action="CTRL/Ctrl_Supp_Appro_Emb.php" method="post">

<fieldset style=" width:1050px;"><legend>Informations sur l'approvisionnement d'emballage à supprimer</legend>
<table >
<tr>
    ...
    <td><input type="text" id="observationappro" name="observationappro" maxlength="" style="width:250px; background:#ECECEC;" value="<?php echo $rslt2['OBSERVATION']; ?>" readonly="readonly"/></td>
</tr>
<tr>
...
<table id='tarticle' border="0" width="100%" align="center">
          <tr align="center" bgcolor="#CCCCCC">
          	<td colspan="3"><h5>Liste des emballages de l'approvisionnement</h5></td>
          </tr>
            <tr bgcolor="#CCCCCC">
...
$couleur = "darkgray";
	...
	$sql='SELECT  E.ID_EMBALLAGE, E.LIBELLE, ER.ID_EMBALLAGE, ER.ID_APPRO, ER.QTERECU FROM EMBALLAGE E, EMBALLAGE_RECU ER WHERE E.ID_EMBALLAGE=ER.ID_EMBALLAGE AND ER.ID_APPRO="'.$_GET['Ap'].'" ORDER BY ER.ID_EMBALLAGE ' ;
